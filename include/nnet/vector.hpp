...
nnet_float dot_product(const nnet_float *vec1, const nnet_float *vec2, std::size_t length);
...
void convolve_valid(const nnet_float *image, const std::size_t *image_dims, const nnet_float *kernel, const std::size_t *kernel_dims, nnet_float *outputs);
void correlate_valid(const nnet_float *image, const std::size_t *image_dims, const nnet_float *kernel, const std::size_t *kernel_dims, nnet_float *output);
void correlate_full(const nnet_float *image, const std::size_t *image_dims, const nnet_float *kernel, const std::size_t *kernel_dims, nnet_float *output);
void rotate_180(nnet_float *input, std::size_t dims, nnet_float *output);
void reverse(nnet_float *input, const std::size_t length);
